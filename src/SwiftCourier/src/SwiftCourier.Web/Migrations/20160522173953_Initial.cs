    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentMethodFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentMethodFields_PaymentMethods_PaymentMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Locations_DestinationLocationId",
                        column: x => x.DestinationLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Bookings_Locations_OriginLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoices", x => x.BookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Packages", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Packages_Users_AssignedToUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Packages_Users_DeliveredByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageLogs_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentMethodFieldValues", x => new { x.PaymentId, x.PaymentMethodFieldId });
                    table.ForeignKey(
                        name: "FK_PaymentMethodFieldValues_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentMethodFieldValues_PaymentMethodFields_PaymentMethodFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DestinationLocationId",
                table: "Bookings",
                column: "DestinationLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_OriginLocationId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_AssignedToUserId",
                table: "Packages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_DeliveredByUserId",
                table: "Packages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethodFields_PaymentMethodId",
                table: "PaymentMethodFields",
                column: "PaymentMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethodFieldValues_PaymentId",
                table: "PaymentMethodFieldValues",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethodFieldValues_PaymentMethodFieldId",
                table: "PaymentMethodFieldValues",
