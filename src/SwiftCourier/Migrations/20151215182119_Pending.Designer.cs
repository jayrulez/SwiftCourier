...
namespace SwiftCourier.Migrations
{
    ...
    [Migration("20151215182119_Pending")]
    partial class Pending
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SwiftCourier.Models.Delivery", b =>
                {
                    ...
                    b.HasAnnotation("Relational:TableName", "Deliveries");
                });
            ...
            modelBuilder.Entity("SwiftCourier.Models.Pickup", b =>
                {
                    b.Property<int>("BookingId");
                    ...
                    b.HasAnnotation("Relational:TableName", "Pickups");
                });
            ...
            modelBuilder.Entity("SwiftCourier.Models.Delivery", b =>
                {
                    b.HasOne("SwiftCourier.Models.Booking")
                        .WithOne()
                        .HasForeignKey("SwiftCourier.Models.Delivery", "BookingId");
                });
